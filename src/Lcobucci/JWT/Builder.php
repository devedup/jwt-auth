...
use Tymon\JWTAuth\Lcobucci\JWT\Claim\Factory as ClaimFactory;
use Tymon\JWTAuth\Lcobucci\JWT\Parsing\Encoder;
use Tymon\JWTAuth\Lcobucci\JWT\Signer\Key;
use Tymon\JWTAuth\Lcobucci\JWT\Token\DataSet;
use Tymon\JWTAuth\Lcobucci\JWT\Token\RegisteredClaimGiven;
use Tymon\JWTAuth\Lcobucci\JWT\Token\RegisteredClaims;
